  ...
  return (
    <div className="w-screen h-screen flex flex-col bg-[#F7F6FA] text-[#191233]">
      ...
      <header className="flex items-center gap-4 px-6 py-4 bg-white border-b border-[#E7E4EF]">
        ...
        <div className="flex items-center gap-2 text-[#7B2FD6] font-bold uppercase tracking-widest text-sm">
      ...
      <div className="flex-1 overflow-auto p-8">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <div className="flex-1 flex items-center bg-white border border-[#E7E4EF] rounded-xl px-4 py-3 shadow-sm focus-within:border-[#7B2FD6] focus-within:ring-1 focus-within:ring-[#7B2FD6] transition-all">
            ...
            <button type="submit" className="px-8 py-3 bg-[#7B2FD6] hover:bg-[#6A28BC] text-white font-bold rounded-xl transition-colors shadow-md">
              Scrape Data
            </button>
          </form>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white p-5 rounded-xl border border-[#E7E4EF] shadow-sm">
              <div className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">Target Keyword</div>
              <div className="text-xl font-semibold tracking-tight text-gray-900 truncate">"{query}"</div>
            </div>
            <div className="bg-white p-5 rounded-xl border border-[#E7E4EF] shadow-sm">
              <div className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">Exposure Volume</div>
              <div className="text-xl font-semibold tracking-tight text-blue-600 flex items-center gap-2"><Globe size={18}/> 14.2M Reach</div>
            </div>
            <div className="bg-white p-5 rounded-xl border border-[#E7E4EF] shadow-sm">
              <div className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">Overall Sentiment</div>
              <div className="text-xl font-semibold tracking-tight text-red-500 flex items-center gap-2"><TrendingUp size={18}/> Negative (68%)</div>
            </div>
            <div className="bg-white p-5 rounded-xl border border-[#E7E4EF] shadow-sm">
              <div className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">Unique Authors</div>
              <div className="text-xl font-semibold tracking-tight text-[#7B2FD6] flex items-center gap-2"><Users size={18}/> 125,430</div>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Interest Over Time */}
            <div className="col-span-2 bg-white rounded-xl border border-[#E7E4EF] p-6 shadow-sm">
              <h2 className="text-sm font-bold text-gray-800 uppercase tracking-widest mb-6 flex items-center gap-2">
                <BarChart3 size={16} className="text-[#7B2FD6]"/> Interest Over Time (24H)
              </h2>
                  ...
                  <AreaChart data={trendData}>
                    <defs>
                      <linearGradient id="colorValue" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor="#7B2FD6" stopOpacity={0.3}/>
                    ...
                    <Area type="monotone" dataKey="value" stroke="#7B2FD6" strokeWidth={2} fillOpacity={1} fill="url(#colorValue)" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </div>
            ...
            {/* Source Distribution */}
            <div className="bg-white rounded-xl border border-[#E7E4EF] p-6 shadow-sm">
              <h2 className="text-sm font-bold text-gray-800 uppercase tracking-widest mb-6 flex items-center gap-2">
                <Globe size={16} className="text-[#7B2FD6]"/> Platform Distribution
              </h2>
              <div className="h-64 w-full">
                <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="bg-white rounded-xl border border-[#E7E4EF] p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-gray-50 border border-gray-100 hover:border-[#C9B2EE] cursor-pointer transition-colors">
                  <span className="text-sm font-medium text-gray-700">{topic}</span>
                  <TrendingUp size={14} className="text-[#7B2FD6]" />
                </div>
              ))}
            </div>
          </div>
