...
export function LaunchScreen() {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-[#F4F2F9] overflow-hidden relative">
      ...
      <div className="relative z-10 w-full max-w-5xl px-8 flex flex-col items-center">
        ...
        <div className="mb-16 flex flex-col items-center animate-in fade-in slide-in-from-bottom-8 duration-700">
          <div className="bg-white p-4 rounded-2xl shadow-xl shadow-purple-900/5 mb-6 border border-white/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          {modules.map((mod, i) => (
            <button
              ...
              className="group text-left bg-white rounded-3xl p-8 border border-gray-100 shadow-lg shadow-gray-200/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-in fade-in slide-in-from-bottom-8"
