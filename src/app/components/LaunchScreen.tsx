...
export function LaunchScreen() {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center overflow-hidden relative" style={{ background: "linear-gradient(135deg, #FFFFFF 0%, #F8F6FC 50%, #EBE4F6 100%)" }}>
      ...
      <div className="relative z-10 w-full max-w-5xl px-8 flex flex-col items-center">
        ...
        <div className="mb-16 flex flex-col items-center animate-in fade-in slide-in-from-bottom-8 duration-700">
          <div className="p-4 rounded-2xl shadow-xl shadow-purple-900/5 mb-6 border border-white/50" style={{ background: "rgba(255, 255, 255, 0.65)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          {modules.map((mod, i) => (
            <button
              ...
              style={{ animationDelay: `${(i + 1) * 150}ms`, background: "rgba(255, 255, 255, 0.65)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)" }}
            >
